...
public class App {
    ...
    public static void main(String[] args){
        ...
        // Print results
        System.out.println("Dijkstra Algorithm - Shortest Paths from Vertex A");
        printShortestPath(algorithm, vertex0, vertex1);
        printShortestPath(algorithm, vertex0, vertex2);
        printShortestPath(algorithm, vertex0, vertex3);
    }

    private static void printShortestPath(DijkstraAlgorithm algorithm, Vertex source, Vertex target) {
        System.out.println("Shortest path from " + source.getName() + " to " + target.getName() + ": " + algorithm.getShortestPathTo(target));
    }
}
